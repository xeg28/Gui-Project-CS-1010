...
def test(y):
    ...
    qlabel = tk.Label(frame_7, text='Question #'+ str(y+1),bg='indianred1',
                       font=('Arial','16','bold'))
    qlabel.place(rely=.18, relx=.75, anchor='w')
    #labels in frame 8
    ...
    qlabel1 = tk.Label(frame_8, text='Question #'+ str(y+1),bg='indianred1',
                       font=('Arial','16','bold'))
    qlabel1.place(rely=.18, relx=.75, anchor='w')
    #Buttons
    ...
    qlabel2 = tk.Label(frame_11, text='Question #'+ str(y+1),bg='indianred1',
                      font=('Arial','16','bold'))
    qlabel2.place(rely=.18, relx=.75, anchor='w')
...
# Labels and text boxes
    ...
    qlabel3 = tk.Label(frame_12, text='Question #'+ str(y+1),bg='indianred1',
                       font=('Arial','16','bold'))
    qlabel3.place(rely=.18, relx=.75, anchor='w')
def func_one():
    global RandomQues
    global QuizResults
    global RandomOpt
