...
L1 = tk.Label(frame_3, text = "Question:",height = 2, width = 30,bg="indianred1", font=('Arial','16'))
L1.place(rely=.11,relx=.05,relheight=.05, anchor='w')

E1 = tk.Entry(frame_3, width = 90)
E1.place(rely=.15,relx=.05,relheight=.05, anchor='w')

L2 = tk.Label(frame_3, text = "Option A:",height = 2, width = 30,bg="indianred1", font=('Arial','16'))
L2.place(rely=.20,relx=.05,relheight=.05, anchor='w')

L3 = tk.Label(frame_3, text = "Option B:",height = 2, width = 30,bg="indianred1", font=('Arial','16'))
L3.place(rely=.35,relx=.05,relheight=.05, anchor='w')

L4 = tk.Label(frame_3, text = "Option C:",height = 2, width = 30,bg="indianred1", font=('Arial','16'))
L4.place(rely=.50,relx=.05,relheight=.05, anchor='w')

L5 = tk.Label(frame_3, text = "Option D:",height = 2, width = 30,bg="indianred1", font=('Arial','16'))
